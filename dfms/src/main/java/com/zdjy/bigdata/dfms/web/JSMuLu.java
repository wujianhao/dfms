...
public class JSMuLu {
	...
	public String  jsml(HttpServletRequest request) throws Exception {
		...
		FileStatus[] listatus = fileSystem.listStatus(new Path("/user/centos"));
	...
	@RequestMapping("xia")
	public String  xia(String dizhi,HttpServletRequest request) throws Exception {
		FileSystem fileSystem = con.connect();
		FileStatus[] listatus = fileSystem.listStatus(new Path(dizhi));
